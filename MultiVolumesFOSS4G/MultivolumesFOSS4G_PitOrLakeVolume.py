...
try:
    #################################   USER DEFINED INPUTS   #########################
    #The input raster
    inras =r"Z:\GISpublic\GerryG\Python3\MultiVolumesFOSS4G\test_data\pit.tif"
    #output file.
    output_csv = r"C:\gTemp\1apit1.csv"
    ...
    #Here is the starting point for summing at decreasing z raster values.
    this_elevation = ras_maximum
    
    while this_elevation >= ras_minimum:
        ...
        for row in myarray: 
            for item in row:
                ...
                if item != no_data and item <= this_elevation:
                    ...
                    graduation_total = graduation_total + ras_maximum - item
